    ...
    <footer className={styles.footer}>
      <div className={styles.footercolums}>
        ...
        <div className={styles.cardColums}>
          ...
          <ul>
            <li>
              <a href="">UrbanLife Club</a>
            </li>
            <li>
              <a href="">Grupo UrbanLife</a>
            </li>
            <li>
              <a href="">Trabaja con nosotros</a>
            </li>
            <li>
              <a href="">Protección de la marca</a>
            </li>
            <li>
        ...
        <div className={styles.cardColums}>
          ...
          <ul>
            ...
            <li>
              <a href="">Coleccion Niños</a>
            </li>
            <li>
              <a href="">Urban para Hombre</a>
            </li>
            <li>
              <a href="">Urban para Mujer</a>
            </li>
            <li>
              <a href="">Zapatería</a>
            </li>
            <li>
              <a href="">Urban Sport</a>
            </li>
            <li>
              <a href="">Chandal Life</a>
            </li>
            <li>
              <a href="">Bolsos de mano para Mujer</a>
            </li>
          </ul>
        </div>
        <div className={styles.cardColums}>
      ...
      <div className={styles.mediosDePago}>
        ...
        <a href="https://www.mercadopago.com">
          <SiMercadopago className={styles.icon} />
        </a>
      </div>
